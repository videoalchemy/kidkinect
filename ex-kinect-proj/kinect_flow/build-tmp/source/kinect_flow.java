...
public class kinect_flow extends PApplet {
...
// import libraries
 ...
 // kinect
 // blobs
  // to handle arraylist reverse function
...
public void setRandomColors(int nthFrame) {
  if (frameCount % nthFrame == 0) {
    ...
    for (int i=0; i<flow.length; i++) {
      flow[i].col = colorPalette[PApplet.parseInt(random(1, colorPalette.length))];
    }
  }
}
...
class PolygonBlob extends Polygon {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "kinect_flow" };
    if (passedArgs != null) {
